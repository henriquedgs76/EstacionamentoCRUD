...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
    ...
    <form id="formRedefinir" runat="server" class="card shadow-lg p-4" style="width: 400px;">
        <h2 class="text-center text-primary mb-4">Definir Nova Senha</h2>
        
        <asp:Label ID="lblMensagem" runat="server" CssClass="text-center fw-bold d-block mt-2 mb-3"></asp:Label>

        <!-- Painel para redefinição de senha, inicialmente invisível -->
        <asp:Panel ID="pnlRedefinicao" runat="server" Visible="false">
            <div class="mb-3">
            ...
            <div class="d-grid mb-3">
                <asp:Button ID="btnRedefinir" runat="server" CssClass="btn btn-primary btn-lg" Text="Salvar Nova Senha" OnClick="btnRedefinir_Click" />
            </div>
        </asp:Panel>
